...
namespace CompanyDirectoryService.Handlers
{
    public class CompanySearchHandler : IHandleMessages<CompanySearchRequest>
    {
        ...
        public async Task Handle(CompanySearchRequest message, IMessageHandlerContext context)
        {
        ...
        public Task HandleAsync(CompanySearchRequest message, IMessageHandlerContext context)
        {
